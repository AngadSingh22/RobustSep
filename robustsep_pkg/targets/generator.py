...
from robustsep_pkg.models.conditioning.drift import DriftSample
...
def generate_target_from_icc_cmyk(
    ...
    *,
    ...
    target, trace = projected_gradient_solve(
        ...
        alpha_app=config.alpha_app,
        alpha_anchor=config.alpha_anchor,
        alpha_ogv=config.alpha_ogv,
        alpha_neutral=config.alpha_neutral,
        beta_risk=config.beta_risk,
        beta_trust=config.beta_trust,
        beta_ogv=config.beta_ogv,
